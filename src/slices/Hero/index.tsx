      ...
      <div className="grid min-h=[70vh] grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className="col-start-1 md:row-start-1">
          ...
          <span onClick={handleTagLineClick}
            className="sub-text cursor-pointer block bg-gradient-to-tr from-purple-500 via-orange-200 to-purple-500 bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent opacity-0 md:text-4xl"
          >
              {selectedTagLine}
          </span>
        </div>
